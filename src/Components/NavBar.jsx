...
function NavBar() {
  ...
  return (
    ...
    <nav className="mobileLayout">
      ...
      <div className="navItemsContainer">
        <img src={isDropDown?crossIcon:hamBurgerIcon} onClick={dropDownHandler} alt="HamBurgerIcon" />
      </div>
    </nav>

    </div>
     
    <div style={isDropDown?{display:'flex'}:{display:'none'}} className="dropDownItemContainer">
